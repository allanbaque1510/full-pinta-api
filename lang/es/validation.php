...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción de `lang/en/validation.php` (Laravel 13), clave por clave, para
    | que ningún error de validación llegue en inglés — es una regla del
    | proyecto (ver CLAUDE.md, "Idioma"). Si Laravel agrega una regla nueva en
    | una versión futura, `php artisan lang:publish` la vuelve a traer en
    | inglés a `lang/en/` y hay que sumarla aquí también.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Convención "atributo.regla" para un mensaje puntual, cuando la traducción
    | genérica de arriba no explica bien el caso concreto del dominio.
    |
    */

    'custom' => [
        'telefono' => [
            'regex' => 'El teléfono debe ser un celular ecuatoriano: 09 seguido de 8 dígitos.',
        ],
        'codigo' => [
            'regex' => 'El código debe tener exactamente 6 dígitos.',
        ],
        'ruc' => [
            'regex' => 'El RUC debe tener exactamente 13 dígitos.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Así el mensaje dice "el campo Teléfono es obligatorio" en vez de "el
    | campo telefono es obligatorio" — con snake_case y sin tilde.
    |
    */
    ...
    'attributes' => [
        ...
        'lng' => 'longitud',
        'whatsapp' => 'WhatsApp',
        'lead_time_min' => 'anticipación mínima',
        'horizonte_dias' => 'horizonte de días',
        'politica_cancelacion_horas' => 'política de cancelación',
        'finalidad' => 'finalidad',
        'otorgado' => 'otorgado',
    ],
